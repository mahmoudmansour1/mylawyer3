    ...
    public function login(Request $request)
    {
        ...
        if($user){
            ...
            if($user['is_active'] == 0){
                ...
                // return response()->json($response, 200);
                $user = $request->user();
                // $message = 'Welcome%20to%20MyLawyer%20,%20please%20use%20the%20following%20activation%20code:%20' . $user->code;
           ...
           // $message = 'Welcome to MyLawyer , please use the following activation code: ' . $lawyer['code'];
            $message = 'Welcome%20to%20MyLawyer%20,%20please%20use%20the%20following%20activation%20code:%20' . $lawyer['code'];
