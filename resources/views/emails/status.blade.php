                                            ...
                                            <tr>
                                                <td width="100%" height="349" align="center" valign="top" style="padding: 10px;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td height="34" align="left" valign="middle" style="padding: 0px; color:#1d1d1b; text-align: center; font-family: sans-serif; font-size: 24px; mso-height-rule: exactly; line-height: 20px;">
                                                                    <strong>#{{ $data['number_request'] }}</strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20" align="left" valign="middle" style="padding: 0px; color:#fcc10f; text-align: center; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px;">
                                                                    {{ date_format(date_create($data['req_date']), 'Y/m/d') }} - {{ date("g:i a", strtotime($data['req_time'])) }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tbody>
                                                            <tr>
                                                                <td height="54" align="left" valign="middle" style="font-family: sans-serif; font-size: 15px;">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="50" align="left" valign="middle" style="padding: 0px; color:#1d1d1b; text-align: center; font-family: sans-serif; font-size: 44px; mso-height-rule: exactly; line-height: 20px; ">
                                                                    <strong>{{ $data['status']['name_en'] }}</strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="20" align="left" valign="middle" style="padding: 0px; color:#878787; text-align: center; font-family: sans-serif; font-size: 14px; mso-height-rule: exactly; line-height: 20px;">
                                                                    {{ $data['reason'] }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="56" align="left" valign="middle" style="font-family: sans-serif; font-size: 15px;">&nbsp;</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="34" align="left" valign="middle" style="padding: 0px; color:#1d1d1b; text-align: center; font-family: sans-serif; font-size: 26px; mso-height-rule: exactly; line-height: 20px; text-transform: uppercase ">
                                                                    <strong>{{ $data['service']['name_en'] }}</strong>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="2" align="left" valign="middle" style="padding: 0px; color:#1d1d1b; text-align: center; font-family: sans-serif; font-size: 26px; mso-height-rule: exactly; line-height: 20px; background: #">
                                                                    <span style="padding: 20px 0; text-align: center">
                                                                        <img src="{{ asset('img/dash_design.jpg') }}" width="310" height="12" alt="alt_text" border="0">
                                                                    </span>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td height="60" align="center" valign="top" style="padding: 0px; color:#878787; text-align: center; font-family: sans-serif; font-size: 16px; mso-height-rule: exactly; line-height: 20px; ">
                                                                    {{ $data['make']['name_en'] }} - {{ $data['model']['name_en'] }} - {{ $data['car_years'] }} <br>
                                                                    {{ $service_info['request_details'] }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="55" align="left" valign="bottom" style="padding: 0px; color:#1d1d1b; text-align: center; font-family: sans-serif; font-size: 26px; mso-height-rule: exactly; line-height: 20px; "><strong>Client address</strong></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="60" align="center" valign="middle" style="padding: 0px; color:#878787; text-align: center; font-family: sans-serif; font-size: 16px; mso-height-rule: exactly; line-height: 20px; ">
                                                                    ...
                                                                    {{ $data['user_phone'] }} - {{ $data['user_email'] }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
